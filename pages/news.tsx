...
const fetchGamingNews = async (query: string, category?: string): Promise<Article[]> => {
...
const News: React.FC = () => {
  ...
  const [isSearchActive, setIsSearchActive] = useState<boolean>(false); // New state to track if a search is active
